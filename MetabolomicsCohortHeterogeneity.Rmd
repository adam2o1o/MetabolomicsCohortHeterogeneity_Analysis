...
# knitr::opts_knit$set(root.dir = "<INSERT DIR CONTAINING DATA FOLDERS HERE>")
```
...
dumbbell_df_long <- dumbbell_df %>%
    # filter(subgroup %in% c("Whole Cohort", "k-means - Cluster 1 (n=409)",
    #                        "LCA - Latent Class 1 (n=206)", "Classifiability - Group 2 (n=287)")) %>%
